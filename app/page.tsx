...
import { KidsCodeCamp } from "./components/KidsCodeCamp";
      ...
      >
        ...
        >
          ...
          <div className="max-w-2xl">
            <Typography
              variant="h1"
              weight="bold"
              className="text-white leading-[1.08] mb-6 md:mb-8 text-3xl md:text-5xl lg:text-[3.5rem]"
            >
              Empowering Businesses,{" "}
              <br className="hidden md:block" />
              Training Talents, and{" "}
              <br className="hidden md:block" />
              <span className="text-brand-green font-heading">Building the Future.</span>
            </Typography>

            <Typography
              variant="body"
              className="text-white/60 mb-8 md:mb-10 text-base md:text-lg leading-relaxed max-w-lg"
            >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12 md:mb-16">
              <Button variant="secondary" className="sm:w-auto rounded-xl text-white px-8 py-5">
                Meet team
              </Button>
              <Button
                variant="outline"
                className="w-full sm:w-auto border-white/20 text-white hover:bg-white/10 rounded-xl px-8 py-5"
              >
                View work
              </Button>
            </div>
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-4 pt-8 md:pt-10 border-t border-white/10">
            <div>
              <Typography variant="h5" weight="bold" className="text-white md:text-2xl">
                5,000+
              </Typography>
              <Typography variant="caption" className="text-white/40 block mt-1 text-[9px] md:text-xs">
                Innovators trained
              </Typography>
            </div>
            <div>
            ...
            <div className="flex flex-col">
              <div className="flex -space-x-2 mb-2">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="w-5 h-5 md:w-7 md:h-7 rounded-full bg-slate-700 border-2 border-brand-purple overflow-hidden"
                  >
                    <div className="w-full h-full bg-linear-to-tr from-brand-purple to-brand-orange opacity-50" />
                  </div>
                ))}
              </div>
              <Typography variant="caption" className="text-white/40 text-[9px] md:text-xs">
                8k+ Community
              </Typography>
            </div>
          </div>
        ...
        >
          ...
          <motion.div
            ...
            className="absolute bottom-4 right-4 left-4 md:bottom-8 md:right-8 md:left-auto md:w-72 bg-brand-purple/40 backdrop-blur-xl border border-white/20 p-4 md:p-5 rounded-3xl flex gap-4 items-center shadow-2xl"
          >
