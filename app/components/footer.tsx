...
export const Footer = () => {
    const sections = [
        {
            title: "Platform",
            links: ["Home", "About Us", "Programs", "Innovation Lab", "Venture Studio"],
        },
        {
            title: "Community",
    ...
    return (
        <footer className="w-full bg-white py-10 px-4 md:px-10"> {/* Outer Page Background */}
            <div className="max-w-[1400px] mx-auto bg-brand-purple rounded-[3rem] p-8 md:p-16 shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start gap-12 mb-20">
                        <div className="max-w-xl">
                            <h2 className="font-heading font-bold text-white leading-[1] mb-6 tracking-tight">
                                Ready to ship <br />
                        ...
                        {/* Newsletter Card */}
                        <div className="w-full lg:w-md bg-white/5 backdrop-blur-md p-8 rounded-3xl border border-white/10">
                            <Typography variant="h6" className="text-white mb-2" weight="bold">Stay in the loop</Typography>
                            <Typography variant="caption" className="text-white/60 mb-6 block">Get tech insights delivered to your inbox.</Typography>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 mb-20 border-t border-white/10 pt-16">
                        ...
                        <div className="col-span-2 md:col-span-1">
                            ...
                            <a href="mailto:hello@ighub.ng" className="text-white hover:text-brand-orange transition-colors block mb-2">hello@ighub.ng</a>
                            <Typography variant="body" className="text-white/50 text-sm italic">Aba, Abia State, Nigeria</Typography>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-8 pt-8 border-t border-white/5">
                        <Typography variant="caption" className="text-white/30 tracking-widest uppercase text-[10px]">
                            © 2026 Innovation Growth Hub • built by IGLabs
                        </Typography>
