        ...
        <div>
            ...
            <section className="md:px-6 px-0 max-w-[1440px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[600px]">
                    ...
                    <div className="md:col-span-8 bg-brand-green rounded-[2.5rem] p-10 relative overflow-hidden duration-700 hover:scale-105 group">
                    ...
                    <div className="md:col-span-4 bg-slate-100 rounded-[2.5rem] p-10 flex flex-col justify-between duration-700 hover:scale-105 hover:bg-brand-orange/10">
                        <div>
                    ...
                    <div className="md:col-span-4 bg-brand-green/10 rounded-[2.5rem] p-10 flex flex-col justify-between border duration-700 hover:scale-105 border-brand-green/20">
                        <div>
                    ...
                    <div className="md:col-span-8 bg-brand-purple rounded-[2.5rem] p-10 duration-700 hover:scale-105 relative overflow-hidden grou">
                        <div className="relative z-10 flex flex-col justify-between h-full">
                            <Typography variant="h3" className="text-white">Tech Tribe</Typography>
                            <Typography variant="body" className="text-slate-500">Our flagship 6-month digital skills program for out-of-school youths looking to build careers in tech. Participants undergo three months of intensive learning, followed by a three-month industry internship to gain hands-on experience.</Typography>
                        </div>
